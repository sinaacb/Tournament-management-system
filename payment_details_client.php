        ...
        if ($deleted == false) {
            ...
            if ($teams_left_to_settle > $confirmed_teams) {
                if ($settled_teams < $confirmed_teams) {
                    ...
                    header("Location: payment_details_client.php?tournament_id=$tournament_id");
                    exit();
                } else {
...
<body>
    ...
    <div class="container">
        ...
        <table>
            ...
            <tr>
                <th>Money in Admin Account (Pending Payment)</th>
                <td><?php echo htmlspecialchars($payment_details['pending_payment']); ?></td>
            </tr>
            <tr>
                <th>Money Transferred to Client Account</th>
                <td><?php echo htmlspecialchars($payment_details['received_payment']); ?></td>
            </tr>
        </table>
        <form method="post">
            <input type="submit" class="btn" value="Settle Payments">
        </form>
        <!-- Go Back Button -->
        <a href="view_registered_tournaments.php" class="go-back-btn">Go Back</a>
    </div>
</body>
</html>
